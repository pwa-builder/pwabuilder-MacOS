...
var path = require('path'),
  util = require('util'),
  platformUtils = require('./platform-utils');
...
function Platform(packageName, platforms) {
  ...
  self.create = function (w3cManifestInfo, rootDir, options, href, callback) {
    ...
    return manifest.convertFromBase(w3cManifestInfo)
      ...
      // persist the platform-specific manifest in the source folder
      .then(function () {
      ...
      // copy the platform-specific manifest in the xcode project folder (MacOSpwa)
      .then(function () {
        self.debug('Copying the manifest ' + constants.platform.name + ' manifest into the ' + macOSpwaDir + ' folder');
        var target = path.join(macOSpwaDir, "manifest.json");

        return manifestTools.writeToFile(platformManifestInfo, target);
      })
      ...
      .then(function () {
        var baseString = 'name = ';
        var findString = baseString + tempAppName;
        var replaceString = baseString + platformUtils.pbxProjNameHelper(newAppName);
      ...
      .then(function () {
        var baseString = 'name = ';
        var findString = baseString + tempAppName + "Tests";
        var replaceString = baseString + platformUtils.pbxProjNameHelper(newAppName + "Tests");
        var filePath = path.join(xcodeProjDir, 'project.pbxproj');
        self.info('Replacing ' + findString + ' in "' + filePath + '" to ' + replaceString + '...');
        return fileTools.replaceFileContent(filePath,
          function (data) {
      ...
      .then(function () {
        var baseString = 'name = ';
        var findString = baseString + platformUtils.pbxProjNameHelper(newAppName);
        var replaceString = baseString + platformUtils.pbxProjNameHelper(newAppName);
        var filePath = path.join(xcodeProjDir, 'project.pbxproj');
        self.info('Replacing ' + findString + ' in "' + filePath + '" to ' + replaceString + '...');
        return fileTools.replaceFileContent(filePath,
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '16', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '32', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '64', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '128', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '256', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '512', imagesDir);
      ...
      .then(function () {
        var fileName1 = platformUtils.getSourcePathForIcon(platformManifestInfo.content, '1024', imagesDir);
